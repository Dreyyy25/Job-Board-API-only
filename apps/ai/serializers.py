...
class JobPostAssistRequestSerializer(serializers.Serializer):
    ...
    job_type_id = serializers.PrimaryKeyRelatedField(queryset=JobType.objects.all(), required=False, allow_null=True)
    location_hint = serializers.CharField(max_length=200, required=False, allow_blank=True, default='')
