    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_stream', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='companies.businessstream')),
                ('user_account', models.OneToOneField(limit_choices_to={'user_type': 'company'}, on_delete=django.db.models.deletion.CASCADE, related_name='company_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
